...
ok_annotations = {'chemical','modifier','experimentType','temperature','chemical','mutation','processing','ERROR','warning','EteRNA','sequence','structure','MAPseq','sequenceSource','signal_to_noise','feature','lig_pos','offset','scaling','normalization','reads','reverse_transcriptase'};
